...
def build(root: Path = ROOT) -> dict[str, Any]:
    ...
    restore = _json(migration / "schema11_restore_drill.json")
    export_drill = _json(migration / "schema11_export_drill.json")
    ...
    _require_equal(restore.get("restore_drill"), "passed", "Schema 11 恢复演练")
    _require_equal(logical.get("quick_check"), "ok", "Schema 11 quick_check")
    _require_equal(export_drill.get("export_restore_drill"), "passed", "Schema 11 导出恢复演练")
