...
FIXTURE_PATH = ROOT / "docs" / "archive" / "tasks" / "07_prompt_catalog" / "fixtures" / "deterministic" / "world_fixtures.json"
...
class PromptCatalogBoundariesTest(unittest.TestCase):
    ...
    def test_writing_fixtures_deterministic_boundaries(self) -> None:
        writing_fixture_path = ROOT / "docs" / "archive" / "tasks" / "07_prompt_catalog" / "fixtures" / "deterministic" / "writing_fixtures.json"
