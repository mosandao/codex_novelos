...
- [ ] `TODO` **用户裁决包( consolidated)**:U2 双模式边界确认/U3 C 级锚点 warning 确认/U4 注入预算(槽 4096B+卡面增量)/U5 schema 迁移执行+备份时点/U6 personas 15 卡试点确认/U7 B 级语料授权/U11 019 迁移是否落生产库/U-dirs 演练方向——**R5 执行与 R6 演练在此等待**
